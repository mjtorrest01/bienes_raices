function eventListener(){document.querySelector(".mobile-menu").addEventListener("click",navegacionReponsive)}function navegacionReponsive(){document.querySelector(".navegacion").classList.toggle("mostrar")}
