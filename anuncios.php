        ...
        <section class="seccion contenedor">
            ...
            <div class="contenedor-anuncios">
                ...
                <div class="anuncio">
                    <p class="etiqueta etiqueta-verde">Nueva</p>
                    <picture>
                        <source srcset="build/img/anuncio4.webp" type="imagen/webp">
                        <source srcset="build/img/anuncio4.jpg" type="imagen/webp">
                ...
                <div class="anuncio">
                    <p class="etiqueta etiqueta-verde">Usada</p>
                    <picture>
                        <source srcset="build/img/anuncio5.webp" type="imagen/webp">
                        <source srcset="build/img/anuncio5.jpg" type="imagen/webp">
                        <img loading="lazy" src="build/img/anuncio5.jpg" alt="anuncio2">
                    </picture>
                    <div class="contenido-anuncio">
                        <h3>Casa Moderna de Lujos</h3>
                        <p>Casa con diseño moderno, asi como tecnologia inteligente y amueblada</p>
                ...
                <div class="anuncio">
                    <p class="etiqueta etiqueta-verde">Alquiler</p>
                    <picture>
                        <source srcset="build/img/anuncio6.webp" type="imagen/webp">
                        <source srcset="build/img/anuncio6.jpg" type="imagen/webp">
                        <img loading="lazy" src="build/img/anuncio6.jpg" alt="anuncio3">
                    </picture>
                    <div class="contenido-anuncio">
                        <h3>Casa con Pisina de Lujo</h3>
                        <p>Casa con pisina y acabados de lujo en la ciudad, excelente oportunidad </p>
